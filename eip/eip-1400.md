...
eip: ERC-1400
title: Security Token Standard With Partitions
...
This standard does not specify any additional functions, but combines ERC-1410 (#1410) and ERC-1594 (#1594) to provide both standard security token functionality as well as partitions (partially fungible tokens) to provide further transparency on transfer restrictions.
...
interface IERC1400 is IERC20 {
  ...
  function operatorTransferByPartition(bytes32 _partition, address _from, address _to, uint256 _amount, bytes _data, bytes _operatorData) external returns (bytes32);
  ...
  function issueByPartition(bytes32 _partition, address _tokenHolder, uint256 _amount, bytes _data) external;
  ...
  function redeemByPartition(bytes32 _partition, uint256 _amount, bytes _data) external;
  ...
  function canTransferByPartition(address _from, address _to, bytes32 _partition, uint256 _amount, bytes _data) external view returns (byte, bytes32, bytes32);    
